...
# 5. Future GLdc Optimization Directions
...
**Direct PVR submission (Patch E)** — For already-sorted opaque geometry, bypass GLdc's buffered submission and write PVR-ready vertex strips directly. This is the highest-upside but most invasive change, recommended only after Patches A–D are stable and counters confirm submission remains the dominant cost.
